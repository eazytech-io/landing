...
const Sponsors = () => {
    return (
        <div className='flex flex-col md:flex-row gap-8 justify-between w-[85%] m-auto mb-12 mt-12'>
            <h1 className='text-left text-3xl font-semibold'>
                Trusted by
                <br></br>
                Top Companies
            </h1>
            <div className='self-center w-[50%] md:w-[10%]'>
                <img src={Sponsor1} alt="" />
            </div>
            <div className='self-center  w-[70%] md:w-[20%]' >
                <img src={Sponsor2} alt="" />
            </div>
            <div className='self-center w-[60%] md:w-[18%]' >
